...
export const makeClaudeAdapter = Effect.fn("makeClaudeAdapter")(function* (
  ...
  const refuseClaudeSessionReplacement = (
    existingContext: ClaudeSessionContext,
    method: "startSession" | "thread/rollback",
  ) =>
    Effect.gen(function* () {
  ...
  const startSession: ClaudeAdapterShape["startSession"] = Effect.fn("startSession")(
    function* (input) {
      ...
      if (existingContext) {
        ...
        yield* refuseClaudeSessionReplacement(existingContext, "startSession");
  ...
  const rollbackThread: ClaudeAdapterShape["rollbackThread"] = Effect.fn("rollbackThread")(
    function* (threadId, numTurns) {
      ...
      if (
        ...
        yield* refuseClaudeSessionReplacement(context, "thread/rollback");
