...
// New Chat must not wait on a down host. Keep the requested checkout when it
// can serve (including the active same-environment worktree). Otherwise the
// primary sibling, then any other reachable copy.
